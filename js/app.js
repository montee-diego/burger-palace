    ...
    input.addEventListener("change", () => {
      ...
      if (optBurger === null) {
        gsap.fromTo(
          "." + input.value,
          0.5,
          { x: "0%", y: "-300%", opacity: 0, "z-index": 2 },
          { x: "0%", y: "-110%", opacity: 1, "z-index": 2 }
        );
        updatePrice(true, input.dataset.price);
        nextBtn.classList.add("enabled");
      } else {
        gsap.fromTo(
          "." + inputBurger[optBurger].value,
          0.5,
          { x: "0%" },
          { x: "200%", opacity: 0 }
        );
    ...
    input.addEventListener("click", () => {
      ...
      if (input.checked) {
        ...
        gsap.fromTo(
          "." + input.value,
          0.5,
          { x: "0%", y: "-300%", opacity: 0, "z-index": 3 + optExtras.listTotal },
          {
            x: "0%",
            y: `-${110 + 10 * optExtras.listTotal}%`,
            opacity: 1,
            "z-index": 3 + optExtras.listTotal,
          }
        );
      } else {
    ...
    input.addEventListener("change", () => {
      ...
      if (input.value === "no-side") {
        if (optSides > 0) {
          ...
          gsap.fromTo(
            "." + inputSides[optSides].value,
            0.5,
            { x: "-45%" },
            { x: "-45%", y: "-300%", opacity: 0 }
          );
    ...
    switch (orderPage) {
      ...
      case 3:
        ...
        gsap.fromTo(
          ".bread-top",
          0.5,
          { x: "0%", y: "-300%", opacity: 0, "z-index": 3 + optExtras.listTotal + 1 },
          {
            x: "0%",
            y: `-${110 + 10 * (optExtras.listTotal + 1)}%`,
            opacity: 1,
            "z-index": 3 + optExtras.listTotal + 1,
          }
        );
        break;
      case 4:
